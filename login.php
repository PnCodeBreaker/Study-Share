    ...
    if(isset($_POST['email']) && isset($_POST['password'])){
       if(!empty(trim($_POST['email'])) && !empty(trim($_POST['password']))){
            ...
            if($con){
                ...
                echo "Account Doesn't Exist <a href='signup'  style=\"text-decoration: none;color:green;\" >Signup</a>";
            }
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">        
            ...
            <br> <input type="password" name="password" maxlength="32" required  placeholder="Password"><br><br><br>
             <input type="submit" value="Log In" name="submit" class="signup" /> </center>
