 ...
 <a class=nav1 href="profile" style="float:right;">Profile</a>
        ...
        <center><br><br><br><br>
                ...
                <form action="" method="post" enctype="multipart/form-data"><br>
                    ...
                    <center><label for="fileid"><div style="font-family:gothamb;border:1px solid black; width:120px; padding-left:25px;padding-right:25px;padding-top:10px;padding-bottom:10px;border-radius:4px;">CHOOSE</div></label></center>
                    <br>
